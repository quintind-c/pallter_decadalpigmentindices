...
if c == None:
    points = ax1.scatter(x=x, y=y, c=None, cmap=cmap, data=data, 
                         s=markersize, color='black', zorder=3)
else:
...
ax1.set_xlabel('$\mathregular{WW_{Upper}}$ (m)', fontweight='normal', size=10, labelpad=2)
ax1.set_ylabel('$\mathregular{T_{min}}$ Depth (m)', fontweight='normal', size=10, labelpad=2)
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/Figure 4 - Water Column Structure/")
filename = Path("Fig4j_MinTempDepthvsWWUpper.pdf")
