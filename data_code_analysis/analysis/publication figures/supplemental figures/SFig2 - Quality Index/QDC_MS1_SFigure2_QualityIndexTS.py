...
ax1.set_ylabel('QI (unitless)', color='Black', fontweight='normal', fontsize=12, labelpad=4)
ax1.set_xlabel('Year', color='Black', fontweight='normal', fontsize=12, labelpad=2)
ax1.set_yscale(yscale)
ax1.set_ylim(0.46, 0.98)
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/supplemental figures/SFig2 - Quality Index/")
filename = Path("SFig2_QualityIndexTS.pdf")
