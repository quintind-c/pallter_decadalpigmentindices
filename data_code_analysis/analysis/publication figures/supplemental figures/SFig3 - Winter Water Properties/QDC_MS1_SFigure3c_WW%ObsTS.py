...
ax1.set_ylabel('$\mathregular{WW_{Obs}}$ (%)', fontweight='normal', size=12, labelpad=4)
...
#plot yearly parameter values (bars)
ax1.bar(x, y, data=data_YM, color='black')
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/supplemental figures/SFig3 - Winter Water Properties/")
filename = Path("SFig3c_WW%ObsTS.pdf")
