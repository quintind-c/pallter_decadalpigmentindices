...
ax1.set_xlabel('Retreat Proximity', fontweight='normal', size=10, labelpad=2)
ax1.set_ylabel('$\mathregular{T_{min}}$ Depth (m)', fontweight='normal', size=10)
...
filename = Path("Fig4f_SIRetrProxvsMinTempDepth.pdf")
