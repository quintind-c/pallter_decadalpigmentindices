...
cbar = fig.colorbar(color_contour, ax=ax1, orientation='vertical', pad=0.025)
cbar.set_label('Temperature (°C)', fontweight='normal', fontsize=10, labelpad=8)
...
filename = Path("Fig3a_WaterColumnTemperatureContour.pdf")
