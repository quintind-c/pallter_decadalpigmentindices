...
ax1.set_ylabel('$\mathregular{S_{Surf}}$ (g $\mathregular{kg^{-1}}$)', fontweight='normal', size=12, labelpad=4)
# ax1.set_ylabel('Surface\nSalinity (g $\mathregular{kg^{-1}}$)', fontweight='normal', size=12, labelpad=4)
...
filename = Path("Fig3f_MLDvSal.pdf")
