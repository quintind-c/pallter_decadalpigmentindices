...
ax1.set_ylabel('PP (mgC $\mathregular{m^{-3}}$ $\mathregular{d^{-1}}$)', 
               color='Black', fontweight='normal', fontsize=10, labelpad=2)
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/Figure 5 - Phyto Growth Metrics/")
filename = Path("Fig5b_PrimaryProductionTS.pdf")
