...
ax1.set_ylabel('$\mathregular{S_{Surf}}$ (g $\mathregular{kg^{-1}}$)', 
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/Supporting Figures/FigS1/")
filename = Path("FigS1_SurfSal.pdf")
