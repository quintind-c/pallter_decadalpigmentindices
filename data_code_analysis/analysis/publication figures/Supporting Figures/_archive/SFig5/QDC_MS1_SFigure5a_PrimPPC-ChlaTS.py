...
ax1.set_ylabel('PrimPPC:Chla (ratio)', fontweight='normal', size=12, labelpad=4)
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/supplemental figures/SFig5 - Secondary Pigment Indices/")
filename = Path("SFig5a_PrimPPC-ChlaTS.pdf")
