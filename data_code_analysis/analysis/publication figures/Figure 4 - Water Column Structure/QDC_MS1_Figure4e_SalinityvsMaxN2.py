...
ax1.set_xlabel('$\mathregular{S_{Surf}}$ (g/kg)', fontweight='normal', size=10, labelpad=2)
ax1.set_ylabel('Max $\mathregular{N^{2}}$ ($\mathregular{s^{-1}}$)', fontweight='normal', size=10)
...
filename = Path("Fig4e_SalinityvsMaxN2.pdf")
