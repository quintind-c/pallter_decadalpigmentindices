...
# ax1.set_title('Cryptophytes', fontweight='normal', fontsize=12)
...
# ax1.bar(x, y, data=data_YM, color='blue', zorder=0)
...
filename = Path("Fig6b_CrypTS.pdf")
