...
ax1.set_ylabel('Evenness (a.u.)', 
               color='Black', fontweight='normal', fontsize=10, labelpad=4)
ax1.set_yscale(yscale)
ax1.set_ylim(0, 1.075)
ax1.set_xlim(1990, 2021)
ax1.minorticks_on()
ax1.tick_params('x', labelbottom=True)
ax1.set_title('Evenness', fontweight='bold', fontsize=11)
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/Figure 7 - Phyto Community Composition/")
filename = Path("Fig7a_EvennessTS2.pdf")
