...
ax1.set_xlabel('Max $\mathregular{N^{2}}$ ($\mathregular{s^{-1}}$)', fontweight='normal', size=12, labelpad=2)
ax1.set_ylabel('PP (mgC $\mathregular{m^{-3}}$ $\mathregular{d^{-1}}$)', 
               fontweight='normal', size=12, labelpad=2)
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/Fig4/")
filename = Path("Fig4g_MaxN2vPP.pdf")
