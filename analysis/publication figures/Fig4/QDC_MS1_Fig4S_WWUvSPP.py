...
ax1.set_xlabel('$\mathregular{WW_{Upper}}$ (m)', fontweight='normal', size=12, labelpad=3)
ax1.set_ylabel('Specific-PP\n(mgC $\mathregular{mgChla^{-1}}$ $\mathregular{d^{-1}}$)', 
...
filename = Path("Fig4S_WWUvSPP.pdf")
