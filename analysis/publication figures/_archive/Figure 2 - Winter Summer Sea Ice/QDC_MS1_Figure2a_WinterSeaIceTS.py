...
line2, = ax1.plot(data_SI['Year'], data_SI['IceDays'], color=c2, lw=lw, 
         marker='D', markersize=ms, label=label, zorder=10)
ax1.set_ylabel('Number of Days', color=c1, fontweight='normal', fontsize=fs)
...
ax1_twin1.set_ylabel('Relative Days', color=c3, fontweight='normal', fontsize=fs)
ax1_twin1.tick_params(axis='y', which='both', colors=c3)
ax1_twin1.set_ylim(-75, 29)
...
filename = Path("Fig2a_WinterSeaIceTS.pdf")
