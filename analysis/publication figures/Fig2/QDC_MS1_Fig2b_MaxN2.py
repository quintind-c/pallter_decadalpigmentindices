...
ax1.set_ylabel('Max $\mathregular{N^{2}}$ ($\mathregular{s^{-1}}$)', 
               color='Black', fontweight='normal', fontsize=12, labelpad=4)
ax1.set_yscale(yscale)
# ax1.set_ylim(32.5, 34.35)
...
# =============================================================================
current_directory = Path.cwd()
absolute_path = Path("analysis/publication figures/Fig2/")
filename = Path("Fig2b_MaxN2.pdf")
